    ...
    render() {
        ...
        return (
            <>
                ...
                <ShopItemControls isInCart={this.props.RootStore.cartStore.inCart(item.id)}
                    add={() => this.props.RootStore.cartStore.add(item.id)}
                    remove={() => this.props.RootStore.cartStore.remove(item.id)} />
            </>
        );
    }
}
